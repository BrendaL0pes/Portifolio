...
export function GithubStreakWidget({ username = "BrendaL0pes" }: { username?: string }) {
  // Cores personalizadas para combinar com o portfólio (roxo/neon)
  const streakUrl = `https://github-readme-streak-stats.herokuapp.com/?user=${username}&theme=transparent&hide_border=true&title_color=cb6ce6&text_color=a3a3a3&icon_color=e879f9&text_bold=false&ring=67e8f9&fire=e879f9&sideNums=a3a3a3&sideLabels=a3a3a3&dates=a3a3a3&currStreakNum=67e8f9&currStreakLabel=67e8f9`
